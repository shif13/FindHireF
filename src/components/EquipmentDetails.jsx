...
// import { MapPin, Calendar, Eye, Mail, Phone, MessageCircle, ArrowLeft, FileText, CheckCircle, XCircle, X, Download } from 'lucide-react';
...
//       const finalUrl = `http://localhost:5550/uploads/${cleanPath}`;
//       setCurrentDocument({ url: finalUrl, name: cleanPath.split('/').pop() });
...
//                   </div>
//                 )}
//                 {equipment.availability === 'on-hire' && (
//                   <div className="absolute bottom-2 right-2 w-8 h-8 bg-red-500 border-4 border-white rounded-full flex items-center justify-center">
...
//                 <span className={equipment.availability === 'available' ? 'text-green-600 font-semibold' : 'text-red-600 font-semibold'}>
//                   {equipment.availability === 'available' ? 'Available' : 'On-Hire'}
//                 </span>
//               </div>
...
//             {/* Action Buttons - Equipment Images */}
// {equipment.equipmentImages && equipment.equipmentImages.length > 0 && (
//   <div className="flex gap-4 justify-center mb-8">
//     {equipment.equipmentImages.map((file, index) => (
//       <button
//         key={index}
//         onClick={() => handleViewDocument(file.path)}
//         className="inline-flex items-center gap-2 px-6 py-3 bg-white border-2 border-emerald-600 text-emerald-600 rounded-lg font-semibold hover:bg-emerald-50 transition-colors"
//       >
...
const EquipmentDetails = () => {
  ...
  const getImageUrl = (imagePath) => {
    ...
    return `https://projectk-6vkc.onrender.com/uploads/${cleanPath}`;
  };
