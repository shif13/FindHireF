          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-3">
              ...
              <div>
                ...
                <p className="text-blue-100">Share your experience with TalentConnect</p>
              </div>
            </div>
            {isModal && onClose && (
              <button
              ...
              <div className="space-y-6">
                ...
                <div>
                  ...
                  <textarea
                    ...
                    placeholder="Share your experience with TalentConnect... (minimum 20 characters)"
                    maxLength={1000}
                  />
                      ...
                      <>
                        <div className="flex items-start justify-between mb-4">
                          <div className="flex items-center space-x-4">
                            ...
                            <div>
                              <div className="flex items-center space-x-3">
                                <h4 className="font-semibold text-gray-900">{review.firstName} {review.lastName}</h4>
